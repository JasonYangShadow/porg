...
pkgdatadir = $(datadir)/porg
pkgincludedir = $(includedir)/porg
pkglibdir = $(libdir)/porg
pkglibexecdir = $(libexecdir)/porg
...
CONFIG_CLEAN_FILES = config-bot.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config-bot.h.in \
	...
	AUTHORS COPYING ChangeLog INSTALL README build/ar-lib \
...
ACLOCAL = ${SHELL} /home/admin/porg/build/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/admin/porg/build/missing autoconf
AUTOHEADER = ${SHELL} /home/admin/porg/build/missing autoheader
AUTOMAKE = ${SHELL} /home/admin/porg/build/missing automake-1.15
AWK = mawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /home/admin/porg/build/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MY_CFLAGS = -W -ansi -Wshadow -Wmissing-declarations -Wall
MY_CXXFLAGS = -W -ansi -pedantic -Wall -fno-operator-names -std=c++11 -Wno-deprecated-declarations
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
...
OTOOL64 = 
PACKAGE = porg
PACKAGE_BUGREPORT = http://porg.sourceforge.net
PACKAGE_NAME = porg
PACKAGE_STRING = porg 0.10
PACKAGE_TARNAME = porg
PACKAGE_URL = 
...
STRIP = strip
VERSION = 0.10
abs_builddir = /home/admin/porg
abs_srcdir = /home/admin/porg
abs_top_builddir = /home/admin/porg
abs_top_srcdir = /home/admin/porg
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/admin/porg/build/install-sh
...
config-bot.h: $(top_builddir)/config.status $(srcdir)/config-bot.h.in
